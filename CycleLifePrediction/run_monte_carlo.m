...
%% ── Monte Carlo Simulation + Confidence Interval Pipeline ───────────────────
%
% Full automated pipeline:
%   1. Load configuration from config.m
%   2. Generate randomised ageing-parameter samples
%   3. Run CyclingAgeing.slx in parallel (one run per sample)
%   4. Save raw Monte Carlo results  →  <save_dir>/monte_carlo_parallel_results.mat
%                                       <save_dir>/monte_carlo_parallel_summary.csv
%   5. Compute 95% confidence intervals and plot against experimental data
%   6. Save CI results  →  <save_dir>/confidence_interval_results.mat
%                          <save_dir>/confidence_interval_data.csv
%
% To change parameters (temperature, ageing rates, MC options), edit config.m.
...
parfor i = 1:num_simulations
    ...
    simIn = simIn.setVariable('SOCs_29',             SOCs_29);
    simIn = simIn.setVariable('OCVs_29',             OCVs_29);
